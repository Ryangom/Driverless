        ...
        <div class="container text-center text-md-left pt-5">
          <div class="row">
            ...
            <div class="col-md-3 mx-auto mb-4">
              <h6 class="text-uppercase font-weight-bold">Driverless</h6>
            ...
            <div class="col-md-2 mx-auto mb-4">
              ...
              <hr class="bg-success mb-4 mt-0 d-inline-block mx-auto" style="width: 110px; height: 2px">
                <ul class="list-unstyled">
                  ...
                  <li class="my-2"><a href="./car.php">Cars</a></li>      
                  <li class="my-2"><a href="./index.php#About_US">About</a></li>
                  <li class="my-2"><a href="./technology.php">Technology</a></li>       
                </ul>
            </div>
            <div class="col-md-3 mx-auto mb-4">
              ...
              <hr class="bg-success mb-4 mt-0 d-inline-block mx-auto" style="width: 75px; height: 2px">
                <ul class="list-unstyled">
                  <li class="my-2"><i class="fas fa-home mr-3"></i> Newcastle upon 5DL, UK</li>
                  <li class="my-2"><i class="fas fa-envelope mr-3"></i> info.driverless@gmail.com</li>
...
<script src="https://kit.fontawesome.com/bffd7c85de.js" crossorigin="anonymous"></script>
